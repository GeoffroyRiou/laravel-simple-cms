...
<section class="{{ $bgColor }} py-5">
    <div class="mx-auto px-5 flex flex-col gap-5 md:flex-row md:justify-center xl:max-w-10/12">
        @foreach ($numbers as $number)
            <div
                class="p-5 flex flex-col gap-5 items-center bg-white border border-indigo-200 rounded-lg md:py-8 md:flex-[1_1_40%] md:max-w-[40%] lg:flex-[1_1_30%] lg:max-w-[30%] xl:flex-[1_1_20%] xl:max-w-[20%]">
